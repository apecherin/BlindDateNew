...
(function() {
  var chat, chat_private, dialog2, messages;
    ...
    countMess: function() {
      return $.ajax({
        ...
        success: function(res) {
          if (res.count > 0) {
            $("#messages_link").html("Почта \+" + res.count);
          }
          if (res.count > 0) {
            return $("#messages_link_main").html("Почта \+" + res.count);
          }
        }
      });
    },
    readMess: function(id) {
      return $.ajax({
  ...
  dialog2 = {
    init: function() {
      return this.modalInit();
    },
    modalInit: function() {
      return $('#messages .mess, .well #user').click(function() {
  ...
  chat_private = {
    init: function() {
      ...
      if (document.getElementById("chat_room_private")) {
        return this.updateScroll_new();
      }
    },
    fayePrivInit: function() {
      var private_subscription;
      return private_subscription = client.subscribe("/messages/private/" + user_id, function(data) {
        var res, tr;
        tr = $("<tr></tr>");
    ...
    updateScroll_new: function(down) {
      var scrollinDiv;
      if (down == null) {
        down = 0;
      }
      scrollinDiv = document.getElementById("chat_room_private");
      return scrollinDiv.scrollTop = Math.pow(100, 10) + down;
    },
    newMessage: function() {
      return $('#new_message_form_private #send').click(function(e) {
        e.preventDefault();
        return chat_private.addMessage();
      });
    },
    addMessage: function() {
      var message;
      ...
      return $.ajax({
        ...
        success: function(res) {
          var result, td_img, td_mess, td_nick_date, tr;
          if (res.success) {
            ...
            $("#message").val("");
            return chat_private.updateScroll_new(300);
          }
        }
      });
    }
  ...
  chat = {
    ...
    fayePubInit: function() {
      var public_subscription;
      return public_subscription = client.subscribe("/messages/public", function(data) {
        var p, result;
        p = $("<p></p>");
        console.log(data);
        result = p.html(data.date + " <a href='/pages/" + data.nick_id + "'>" + data.nick + "</a>" + ": " + data.mess);
        result.appendTo("#chat_room");
        return chat.updateScroll(300);
      });
    },
    updateScroll: function(down) {
      var scrollinDiv;
      if (down == null) {
        down = 0;
      }
